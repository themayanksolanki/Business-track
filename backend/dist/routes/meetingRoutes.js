...
import { createMeeting, getMeetingByRoomCode, joinMeeting, leaveMeeting, endMeeting, updateMeeting, cancelMeeting, getUpcomingMeetings, getMeetingHistory, } from '../controllers/meetingController.js';
const router = Router();
