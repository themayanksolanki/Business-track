...
import { validateDepartment, validateDepartmentId, } from '../middleware/validate.js';
...
router.put('/:id', protect, allowRoles('Admin', 'Manager'), validateDepartmentId, validateDepartment, updateDepartment);
