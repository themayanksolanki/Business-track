...
import { validateProject, validateProjectItem, validateReorder, validateMove, validateMoveToParent, validateMoveToProject, validateBulkMoveToParent, validateBulkMoveToProject, validateComment, validateProjectId, validateItemId, validateCommentId, validateAttachmentId, validateAttachmentLink, validateAddMember, validateUpdateMemberRole, validateMemberId, validateProjectDetailsLayout, validateApproverAssignment, validateApproverUserId, } from '../middleware/validate.js';
...
import { getApprovers, assignApprovers, removeApprover, approveItem, requestChanges, reRequestApproval, getApprovalHistory, getApprovalComments, createApprovalComment, updateApprovalComment, deleteApprovalComment, } from '../controllers/taskApprovalController.js';
...
router.patch('/:projectId/details-layout', protect, validateProjectId, validateProjectDetailsLayout, updateProjectDetailsLayout);
...
router.post('/:projectId/attachments', protect, validateProjectId, attachmentUpload, uploadProjectAttachment);
router.get('/:projectId/attachments/:attachmentId/download', protect, validateProjectId, validateAttachmentId, downloadProjectAttachment);
router.delete('/:projectId/attachments/:attachmentId', protect, validateProjectId, validateAttachmentId, deleteProjectAttachment);
...
router.patch('/:projectId/members/:memberId', protect, validateProjectId, validateMemberId, validateUpdateMemberRole, updateMemberRole);
...
router.patch('/:projectId/items/:itemId/move', protect, validateProjectId, validateItemId, validateMove, moveItem);
...
router.get('/:projectId/items/:itemId/comments', protect, validateProjectId, validateItemId, getComments);
router.post('/:projectId/items/:itemId/comments', protect, validateProjectId, validateItemId, validateComment, createComment);
router.patch('/:projectId/items/:itemId/comments/:commentId', protect, validateProjectId, validateItemId, validateCommentId, validateComment, updateComment);
router.delete('/:projectId/items/:itemId/comments/:commentId', protect, validateProjectId, validateItemId, validateCommentId, deleteComment);
router.get('/:projectId/items/:itemId/approvers', protect, validateProjectId, validateItemId, getApprovers);
router.post('/:projectId/items/:itemId/approvers', protect, validateProjectId, validateItemId, validateApproverAssignment, assignApprovers);
router.delete('/:projectId/items/:itemId/approvers/:userId', protect, validateProjectId, validateItemId, validateApproverUserId, removeApprover);
router.post('/:projectId/items/:itemId/approve', protect, validateProjectId, validateItemId, approveItem);
router.post('/:projectId/items/:itemId/request-changes', protect, validateProjectId, validateItemId, requestChanges);
router.post('/:projectId/items/:itemId/re-request', protect, validateProjectId, validateItemId, reRequestApproval);
router.get('/:projectId/items/:itemId/approval-history', protect, validateProjectId, validateItemId, getApprovalHistory);
router.get('/:projectId/items/:itemId/approval-comments', protect, validateProjectId, validateItemId, getApprovalComments);
router.post('/:projectId/items/:itemId/approval-comments', protect, validateProjectId, validateItemId, validateComment, createApprovalComment);
router.patch('/:projectId/items/:itemId/approval-comments/:commentId', protect, validateProjectId, validateItemId, validateCommentId, validateComment, updateApprovalComment);
router.delete('/:projectId/items/:itemId/approval-comments/:commentId', protect, validateProjectId, validateItemId, validateCommentId, deleteApprovalComment);
router.get('/:projectId/items/:itemId/attachments', protect, validateProjectId, validateItemId, getItemAttachments);
router.post('/:projectId/items/:itemId/attachments', protect, validateProjectId, validateItemId, attachmentUpload, uploadItemAttachment);
router.post('/:projectId/items/:itemId/attachments/link', protect, validateProjectId, validateItemId, validateAttachmentLink, addItemAttachmentLink);
router.get('/:projectId/items/:itemId/attachments/:attachmentId/download', protect, validateProjectId, validateItemId, validateAttachmentId, downloadItemAttachment);
router.delete('/:projectId/items/:itemId/attachments/:attachmentId', protect, validateProjectId, validateItemId, validateAttachmentId, deleteItemAttachment);
router.post('/:projectId/items/:itemId/attachments/:attachmentId/undo', protect, validateProjectId, validateItemId, validateAttachmentId, undoItemAttachment);
