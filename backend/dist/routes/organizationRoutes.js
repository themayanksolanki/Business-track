...
import { getMyOrganization, updateOrganization, getAdmins, createInvite, getInvites, revokeInvite, activateInvite, getInviteByToken, acceptInviteByToken, } from '../controllers/organizationController.js';
const router = Router();
...
router.delete('/invites/:id', protect, allowRoles('Admin', 'Manager', 'Team Lead'), validateObjectId, revokeInvite);
router.post('/invites/:id/activate', protect, allowRoles('Admin', 'Manager', 'Team Lead'), validateObjectId, validateActivateInvite, activateInvite);
