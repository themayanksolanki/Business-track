...
const SUPPORTED_TYPES_LABEL = 'images (JPG, PNG, WEBP, GIF), videos (MP4, WEBM, MOV, MKV), PDF, Word, Excel, PowerPoint, ZIP, and text/CSV files';
export const attachmentUpload = multer({
    ...
    fileFilter: (_req, file, cb) => {
        if (ALLOWED_MIME_TYPES.includes(file.mimetype)) {
            ...
            cb(new AppError(`"${file.originalname}" is not a supported file type. Supported formats: ${SUPPORTED_TYPES_LABEL}.`, 400));
        }
    },
}).single('file');
