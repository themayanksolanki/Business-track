...
const isCloudinaryUploadError = (err: any) => typeof err.http_code === 'number' && typeof err.message === 'string';

const handleCloudinaryUploadError = (err: any) => new AppError(err.message, err.http_code < 500 ? err.http_code : 502);
...
const isAwsError = (err: any) => typeof err?.$metadata?.httpStatusCode === 'number' && typeof err.message === 'string';
