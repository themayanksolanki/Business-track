export interface Country {
  iso2: string; // ISO 3166-1 alpha-2, e.g. "US", "IN"
  name: string;
  dialCode: string; // E.164 calling code, e.g. "+1", "+91"
}

// Regional Indicator Symbols: a flag emoji is just two of these back to back,
// one per letter of the ISO code — no image assets or hardcoded emoji needed.
...
// Sorted by name so native <select> typeahead (type "in" -> jumps to the
// first option whose text starts with "in") lands on "India" as expected.
